...
class MakaoCoreStandardTitle extends MakaoCoreTitle {
	...
	function add_inline_styles( $style ) {
		...
		$color      = makao_core_get_post_value_through_levels( 'qodef_page_title_subtitle_color' );
		$top_margin = makao_core_get_post_value_through_levels( 'qodef_page_title_subtitle_top_margin' );
