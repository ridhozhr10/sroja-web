...
if ( ! function_exists( 'makao_core_add_simple_line_icons_to_collection' ) ) {
	function makao_core_add_simple_line_icons_to_collection( $icons ) {
		$icons[] = 'MakaoCoreSimpleLineIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'makao_core_add_simple_line_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MakaoCoreSimpleLineIconsPack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return MAKAO_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/' . $this->get_base() . '.min.css';
		}
