...
if ( ! function_exists( 'makao_core_add_material_icons_to_collection' ) ) {
	function makao_core_add_material_icons_to_collection( $icons ) {
		$icons[] = 'MakaoCoreMaterialIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'makao_core_add_material_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MakaoCoreMaterialIconsPack extends QodeFrameworkIconPack {
