...
if ( ! function_exists( 'makao_core_add_linear_icons_to_collection' ) ) {
	function makao_core_add_linear_icons_to_collection( $icons ) {
		$icons[] = 'MakaoCoreLinearIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'makao_core_add_linear_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MakaoCoreLinearIconsPack extends QodeFrameworkIconPack {
