...
if ( ! function_exists( 'makao_core_add_linea_icons_to_collection' ) ) {
	function makao_core_add_linea_icons_to_collection( $icons) {
		$icons[] = 'MakaoCoreLineaIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'makao_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MakaoCoreLineaIconsPack extends QodeFrameworkIconPack {
