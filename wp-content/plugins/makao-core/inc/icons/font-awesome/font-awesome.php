...
if ( ! function_exists( 'makao_core_add_font_awesome_to_collection' ) ) {
	function makao_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'MakaoCoreFontAwesomePack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'makao_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class MakaoCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return MAKAO_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
