...
if ( ! function_exists( 'makao_core_add_standard_mobile_header_options' ) ) {
	function makao_core_add_standard_mobile_header_options( $page ) {
		
		$section = $page->add_section_element(
			array(
				'name'       => 'qodef_standard_mobile_header_section',
				'title'      => esc_html__( 'Standard Mobile Header', 'makao-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'makao_core_action_after_mobile_header_options_map', 'makao_core_add_standard_mobile_header_options' );
}