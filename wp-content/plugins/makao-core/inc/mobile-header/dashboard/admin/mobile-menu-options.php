...
if ( ! function_exists( 'makao_core_mobile_header_menu_options' ) ) {
	function makao_core_mobile_header_menu_options( $page ) {
		...
		if ( $page ) {
			...
			$typography_section = $page->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Mobile Menu Typography', 'makao-core' ),
					'dependency' => array(
						'hide' => array(
							'qodef_mobile_header_layout' => array(
								'values'        => makao_core_dependency_for_mobile_menu_typography_options(),
	...
	add_action( 'makao_core_action_after_mobile_header_options_map', 'makao_core_mobile_header_menu_options', 15 );
}