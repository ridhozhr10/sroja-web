...
if ( ! function_exists( 'makao_core_add_page_mobile_logo_meta_box' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function makao_core_add_page_mobile_logo_meta_box( $logo_tab ) {
		...
		if ( $logo_tab ) {
			...
			do_action( 'makao_core_action_after_page_mobile_logo_meta_map', $mobile_header_logo_section );
		}
	}
	
	add_action( 'makao_core_action_after_page_logo_meta_map', 'makao_core_add_page_mobile_logo_meta_box' );
}