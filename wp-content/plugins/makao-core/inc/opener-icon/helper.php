...
if ( ! function_exists( 'makao_core_get_opener_icon_class' ) ) {
	/**
	 ...
	 * @return string
	 */
	function makao_core_get_opener_icon_class( $option_name, $custom_class = '' ) {
		$class = array();
		
		if ( ! empty( $option_name ) ) {
			$icon_source  = makao_core_get_option_value( 'admin', 'qodef_' . esc_attr( $option_name ) . '_icon_source' );
...
if ( ! function_exists( 'makao_core_get_opener_icon_html' ) ) {
	/**
	 ...
	 */
	function makao_core_get_opener_icon_html( $params = array(), $has_close_icon = false, $set_icon_as_close = false, $has_close_text = false ) {
		$args = array(
			'html_tag'          => '',
			'option_name'       => '',
			'custom_icon'       => '',
		...
		makao_core_template_part( 'opener-icon', 'templates/opener-icon', $args['html_tag'], $args );
	}
}

if ( ! function_exists( 'makao_core_get_opener_icon_html_content' ) ) {
	/**
	 * Returns html for opener icon sources
	 *
	 ...
	 * @return string/html
	 */
	function makao_core_get_opener_icon_html_content( $option_name, $is_close_icon = false, $custom_icon = '' ) {
		$html = '';
		...
		$icon_source         = makao_core_get_option_value( 'admin', 'qodef_' . esc_attr( $option_name ) . '_icon_source' );
		$icon_pack           = makao_core_get_option_value( 'admin', 'qodef_' . esc_attr( $option_name ) . '_icon_pack' );
		$icon_svg_path       = makao_core_get_option_value( 'admin', 'qodef_' . esc_attr( $option_name ) . '_icon_svg_path' );
		$close_icon_svg_path = makao_core_get_option_value( 'admin', 'qodef_' . esc_attr( $option_name ) . '_close_icon_svg_path' );
