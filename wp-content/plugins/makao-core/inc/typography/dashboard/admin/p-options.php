...
if ( ! function_exists( 'makao_core_add_p_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function makao_core_add_p_typography_options( $page ) {
		...
		if( $page ) {
			$paragraph_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-paragraph',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Paragraph Typography', 'makao-core' ),
					'description' => esc_html__( 'Set values for paragraph', 'makao-core' )
				)
			);
	...
	add_action( 'makao_core_action_after_typography_options_map', 'makao_core_add_p_typography_options' );
}