...
if ( ! function_exists( 'makao_core_add_h4_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function makao_core_add_h4_typography_options( $page ) {
		...
		if ( $page ) {
			$h4_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h4',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H4 Typography', 'makao-core' ),
					'description' => esc_html__( 'Set values for Heading 4 HTML element', 'makao-core' )
				)
			);
	...
	add_action( 'makao_core_action_after_typography_options_map', 'makao_core_add_h4_typography_options' );
}