...
if ( ! function_exists( 'makao_core_add_h3_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function makao_core_add_h3_typography_options( $page ) {
		...
		if ( $page ) {
			$h3_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h3',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H3 Typography', 'makao-core' ),
					'description' => esc_html__( 'Set values for Heading 3 HTML element', 'makao-core' )
				)
			);
	...
	add_action( 'makao_core_action_after_typography_options_map', 'makao_core_add_h3_typography_options' );
}