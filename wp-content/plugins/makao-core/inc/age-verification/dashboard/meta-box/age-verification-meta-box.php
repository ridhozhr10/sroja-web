...
if ( ! function_exists( 'makao_core_add_age_verification_single_meta_box' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function makao_core_add_age_verification_single_meta_box( $page ) {
		...
		if ( $page ) {
			...
			$age_verification_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Age Verification Settings', 'makao-core' ),
			...
			do_action( 'makao_core_action_after_page_age_verification_meta_box_map', $age_verification_tab );
		}
	}
	
	add_action( 'makao_core_action_after_general_meta_box_map', 'makao_core_add_age_verification_single_meta_box' );
}