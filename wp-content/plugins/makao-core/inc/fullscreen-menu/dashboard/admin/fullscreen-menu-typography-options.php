...
if ( ! function_exists( 'makao_core_fullscreen_menu_typography_options' ) ) {
	function makao_core_fullscreen_menu_typography_options( $page ) {
		...
		if ( $page ) {
			...
			$typography_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Fullscreen Menu Typography', 'makao-core' )
				)
			);
	...
	add_action( 'makao_core_action_after_fullscreen_menu_options_map', 'makao_core_fullscreen_menu_typography_options', 15 );
}