...
class MakaoCoreElementorAccordion extends \Elementor\Widget_Base{
	...
	public function set_object(){
			$this->object = qode_framework_get_framework_root()->get_shortcodes()->get_shortcode('makao_core_accordion');
	}
...
makao_core_get_elementor_widgets_manager()->register_widget_type( new MakaoCoreElementorAccordion() );