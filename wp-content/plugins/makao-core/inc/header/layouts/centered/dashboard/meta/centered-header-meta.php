...
if ( ! function_exists( 'makao_core_add_centered_header_meta' ) ) {
	function makao_core_add_centered_header_meta( $page ) {
	...
	add_action( 'makao_core_action_after_page_header_meta_map', 'makao_core_add_centered_header_meta' );
}