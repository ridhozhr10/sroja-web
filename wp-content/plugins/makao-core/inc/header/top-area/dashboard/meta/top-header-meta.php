<?php
if ( ! function_exists( 'makao_core_add_top_area_meta_options' ) ) {
	function makao_core_add_top_area_meta_options( $page ) {
	...
	add_action( 'makao_core_action_after_page_header_meta_map', 'makao_core_add_top_area_meta_options', 20 );
}