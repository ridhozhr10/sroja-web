    ...
    <div class="qodef-sp-inner">
        ...
        <?php if ( ! empty( $title ) ) : ?>
            <h3 class="qodef-sp-title">
                <?php echo makao_return_module_part( makao_return_capsed_word( $title, 3 ) ); ?>
            </h3>
        <?php endif; ?>
        ...
        <?php if ( $enable_prevent === 'yes' ) : ?>
            <div class="qodef-sp-prevent">
                <div class="qodef-sp-prevent-inner">
                    ...
                    <label class="qodef-sp-prevent-label"><?php esc_html_e( 'Prevent This Pop-up', 'makao-core' ); ?></label>
                </div>
            </div>
        <?php endif; ?>
    </div>
