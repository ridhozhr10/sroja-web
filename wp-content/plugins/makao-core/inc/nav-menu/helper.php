...
if ( ! function_exists( 'makao_core_dropdown_item_classes' ) ) {
	function makao_core_dropdown_item_classes( $classes, $item, $args, $depth ) {
		
		if ( $depth == 0 && in_array( 'menu-item-has-children', $item->classes ) ) {
			$mega_menu   = makao_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu', '', $item->ID );
			...
			if ( $mega_menu_e ) {
				...
				add_filter( 'makao_core_filter_drop_down_second_inner_classes', function ( $innerClasses ) {
					$grid_class = false;
					$full_width = makao_core_get_post_value_through_levels( 'qodef_wide_dropdown_full_width' );
					$grid = makao_core_get_post_value_through_levels( 'qodef_wide_dropdown_content_grid' );
					
					if ( $grid == 'yes' || $full_width == 'no') {
						$grid_class = true;
					}
					
					$grid_class = apply_filters('makao_core_filter_drop_down_grid', $grid_class);
	...
	add_filter( 'nav_menu_css_class', 'makao_core_dropdown_item_classes', 11, 4 );
}

if ( ! function_exists( 'makao_core_add_nav_menu_body_classes' ) ) {
	function makao_core_add_nav_menu_body_classes( $classes ) {
		$full_width = makao_core_get_post_value_through_levels( 'qodef_wide_dropdown_full_width' );
		$appearance = makao_core_get_post_value_through_levels( 'qodef_dropdown_appearance' );
	...
	add_filter( 'body_class', 'makao_core_add_nav_menu_body_classes' );
}

if ( ! function_exists( 'makao_core_set_nav_menu_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function makao_core_set_nav_menu_styles( $style ) {
		$styles = array();
		
		$dropdown_top_position = makao_core_get_post_value_through_levels( 'qodef_dropdown_top_position' );
	...
	add_filter( 'makao_filter_add_inline_style', 'makao_core_set_nav_menu_styles' );
}

if ( ! function_exists( 'makao_core_set_nav_menu_typography_styles' ) ) {
	/**
	 * Function that generates module inline styles
	 *
	 * @param $style string
	 ...
	 * @return string
	 */
	function makao_core_set_nav_menu_typography_styles( $style ) {
		$scope = MAKAO_CORE_OPTIONS_NAME;
		
		$first_lvl_styles             = makao_core_get_typography_styles( $scope, 'qodef_nav_1st_lvl' );
		$first_lvl_hover_styles       = makao_core_get_typography_hover_styles( $scope, 'qodef_nav_1st_lvl' );
		$second_lvl_styles            = makao_core_get_typography_styles( $scope, 'qodef_nav_2nd_lvl' );
        $second_lvl_hover_styles      = makao_core_get_typography_hover_styles( $scope, 'qodef_nav_2nd_lvl' );
		$second_lvl_wide_styles       = makao_core_get_typography_styles( $scope, 'qodef_nav_2nd_lvl_wide' );
        $second_lvl_wide_hover_styles = makao_core_get_typography_hover_styles( $scope, 'qodef_nav_2nd_lvl_wide' );
		$third_lvl_wide_styles        = makao_core_get_typography_styles( $scope, 'qodef_nav_3rd_lvl_wide' );
        $third_lvl_wide_hover_styles  = makao_core_get_typography_hover_styles( $scope, 'qodef_nav_3rd_lvl_wide' );
		
		$header_selector      = apply_filters( 'makao_core_filter_nav_menu_header_selector', '.qodef-header-navigation' );
		$narrow_menu_selector = apply_filters( 'makao_core_filter_nav_menu_narrow_header_selector', '.qodef-menu-item--narrow' );
		$wide_menu_selector   = '.qodef-menu-item--wide';
		
		$first_lvl_side_padding = makao_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_padding' );
		...
		$first_lvl_active_color = makao_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_active_color' );
		...
		$first_lvl_side_margin = makao_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_margin' );
		...
		$second_lvl_active_color = makao_core_get_option_value( 'admin', 'qodef_nav_2nd_lvl_active_color' );
		...
		$second_lvl_wide_active_color = makao_core_get_option_value( 'admin', 'qodef_nav_2nd_lvl_wide_active_color' );
		...
		$third_lvl_wide_active_color = makao_core_get_option_value( 'admin', 'qodef_nav_3rd_lvl_wide_active_color' );
	...
	add_filter( 'makao_filter_add_inline_style', 'makao_core_set_nav_menu_typography_styles' );
}