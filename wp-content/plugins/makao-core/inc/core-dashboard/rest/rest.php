...
if ( ! class_exists( 'MakaoCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class MakaoCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'makao-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'makao_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	MakaoCoreDashboardRestAPI::get_instance();
}