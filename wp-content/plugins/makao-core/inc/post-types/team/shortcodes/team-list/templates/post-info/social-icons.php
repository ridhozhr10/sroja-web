...
if ( ! empty( $social_icons ) ) {
	...
	<div class="qodef-team-member-social-icons">
		<h6 class="qodef-team-member-social-network-label"><?php echo esc_html__('Social Networks', 'makao-core')?></h6>
