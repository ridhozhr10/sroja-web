(function ($) {
            ...
            if (typeof google === 'object' && typeof google.maps.places === 'object') {
                ...
                autocomplete.addListener('place_changed', function () {
                    ...
                    if (listHolder) {
                        ...
                        qodefCore.body.trigger('makao_trigger_after_autocomplete_places', [listHolder]);
    ...
    qodefCore.qodefGoogleMultipleMap = qodefGoogleMultipleMap;
    ...
    function qodefReinitMultipleGoogleMaps(addresses, action) {
        if (action === 'append') {
            var mapObjs = qodefMultipleMapVars.multiple.addresses.concat(addresses);
