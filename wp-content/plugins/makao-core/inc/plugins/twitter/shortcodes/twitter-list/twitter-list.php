...
if ( ! function_exists( 'makao_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function makao_core_add_twitter_list_shortcode( $shortcodes ) {
		if( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'MakaoCoreTwitterListShortcode';
		}
		
		return $shortcodes;
	}
	
	add_filter( 'makao_core_filter_register_shortcodes', 'makao_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'MakaoCoreListShortcode' ) ) {
	class MakaoCoreTwitterListShortcode extends MakaoCoreListShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( MAKAO_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'makao_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'makao-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'makao-core' ) );
			...
			$this->set_option( array(
				...
				'field_type' => 'text',
				'title'      => esc_html__( 'Number of Tweets', 'makao-core' ),
				'group'      => esc_html__( 'Info', 'makao-core' )
			) );
			$this->set_option( array(
				'name'          => 'show_retweeted_text',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Retweeted Text', 'makao-core' ),
			...
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Avatar Image', 'makao-core' ),
				'options'       => makao_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'makao-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Author Name', 'makao-core' ),
				'options'       => makao_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'makao-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Text', 'makao-core' ),
				'options'       => makao_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'makao-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Media Placeholder', 'makao-core' ),
			...
			$this->set_option( array(
				'name'          => 'show_date',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Date', 'makao-core' ),
				'options'       => makao_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'makao-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Actions', 'makao-core' ),
				'options'       => makao_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'makao-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Twitter Link', 'makao-core' ),
				'options'       => makao_core_get_select_type_options_pool( 'no_yes' ),
				'default_value' => 'no',
				'group'         => esc_html__( 'Info', 'makao-core' )
			) );
		...
		public function render( $options, $content = null ) {
			...
			return makao_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
